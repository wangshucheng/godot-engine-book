...
6. **撕裂效果增加真实感**，疲劳系统模拟渐进破坏
7. **布料材质预设简化配置**，8 种常见材质
8. **动态材质切换实现特效**，浸湿、冰冻等
...
| Tear Strength | 撕裂强度，材料抵抗撕裂的能力 |
| Fatigue | 疲劳，应力累积导致的渐进损伤 |
| Material Preset | 材质预设，预定义的布料参数 |
...
- **说明**: Godot 的布料通常用质点弹簧/PBD 自行实现，SoftBody3D 适合软体而非布料
- **源码位置**: `scene/3d/physics_body_3d.cpp`, `servers/physics_3d/`
